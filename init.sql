...
CREATE ROLE __APP__ LOGIN PASSWORD '__APP_PASSWORD__';
CREATE SCHEMA __APP__ AUTHORIZATION __APP__;
REVOKE ALL ON SCHEMA __APP__ FROM PUBLIC;
GRANT USAGE ON SCHEMA __APP__ TO __APP__;
GRANT CREATE ON SCHEMA __APP__ TO __APP__;
GRANT USAGE ON SCHEMA __APP__ TO postgres;
GRANT CREATE ON SCHEMA __APP__ TO postgres;
